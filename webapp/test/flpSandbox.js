		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#namecrisusuarios-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"namecrisusuarios-display": {
								"semanticObject": "namecrisusuarios",
								"action": "display",
								"description": "Lista de usuarios decricion",
								"title": "Lista de usuarios",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=namecris.usuarios",
									"url": sap.ui.require.toUrl("namecris/usuarios")
								}
							}
						}
					}
